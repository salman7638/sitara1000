...
class ProductTemplate(models.Model):
    ...
    stage_id = fields.Many2one('product.template.stage', string='Stage',compute='_compute_categ', ondelete='restrict',tracking=True, index=True, copy=False, group_expand='_read_group_stage_ids', domain="[('id', '=', stages)]")
    ...
    def _check_categ(self):
        for line in self:
            if line.categ_id:
                line.stages = line.categ_id.stage_ids.ids
